                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ route('customer_packages_list_show') }}" class="dashboard-widget text-center red-widget text-white mt-4 d-block">
                                    ...
                                    <img src="{{ asset($customer_package->logo) }}" height="44" class="img-fit mw-100 mx-auto mb-1">
                                    <span class="d-block sub-title mb-2">{{__('Current Package')}}: {{ $customer_package->name }}</span>
                                    @else
