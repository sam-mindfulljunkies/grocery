                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="{{ route('seller.digitalproducts') }}">{{__('Digital Products')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mx-auto">
                                <a class="dashboard-widget text-center plus-widget mt-4 d-block" href="{{ route('seller.digitalproducts.upload')}}">
                                    ...
                                    <span class="d-block title heading-6 strong-400 c-base-1">{{ __('Add New Digital Product') }}</span>
                                </a>
                            </div>
                            @if (\App\Addon::where('unique_identifier', 'seller_subscription')->first() != null && \App\Addon::where('unique_identifier', 'seller_subscription')->first()->activated)
                            @php
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton-{{ $key }}">
                                                            <a href="{{route('seller.digitalproducts.edit', encrypt($product->id))}}" class="dropdown-item">{{__('Edit')}}</a>
        					                                <button onclick="confirm_modal('{{route('digitalproducts.destroy', $product->id)}}')" class="dropdown-item">{{__('Delete')}}</button>
                                                            <a href="{{route('digitalproducts.download', encrypt($product->id))}}" class="dropdown-item">{{__('Download')}}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
